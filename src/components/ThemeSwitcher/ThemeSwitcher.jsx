...
export function ThemeSwitcher() {
	...
	return (
		<button id="themeButton" className={styles.themeButton} onClick={clickHandler}>
			<svg width="64" height="32" viewBox="0 0 64 32" fill="none" xmlns="http://www.w3.org/2000/svg">
				<g id="Switches / Switch off">
					<path id="Rectangle"
					      ...
					      fill="white" stroke="#ACACAC" strokeWidth="2"/>
					<path id="Rectangle_2" fillRule="evenodd" clipRule="evenodd"
